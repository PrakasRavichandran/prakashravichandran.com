  ...
  return (
    <Section id={'intro'} className={'gap-6'}>
      ...
      >
        <Img
          src={photo}
          alt={'Photo of Prakash Ravichandran'}
          width={160}
          height={160}
          priority
          className={cx(
        ...
        <p className={'text-pretty flex flex-col gap-2 max-w-[28rem]'}>
          <span>
            Passionate and creative embedded systems engineer from{' '}
            <Link
              title={'India'}
          ...
          <span>
            ...
            software and hardware while enhancing my skills along the way
          </span>
        </p>
      </div>
