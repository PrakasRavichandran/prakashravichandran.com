  ...
  return (
    <ul className={cx('flex flex-row items-center gap-1.5', props.className)}>
      <li>
        <SocialLink
          title={'GitHub'}
          href={'https://github.com/PrakasRavichandran'}
          iconPath={github}
          className={
      ...
      <li>
        <SocialLink
          title={'LinkedIn'}
          href={'https://linkedin.com/in/prakashravichandran10'}
          iconPath={
      ...
      <li>
        <SocialLink
          ...
          href={'https://twitter.com/@Prakash_r10'}
          className={cx(
            'leading-none',
      ...
      <li>
        <SocialLink
          title={'Instagram'}
          href={'https://instagram.com/prakashravichandrann'}
          iconPath={
      ...
      <li>
        <SocialLink
          title={'Email'}
          href={'mailto:prakashravichandran253@gmail.com?subject=Hi%20Prakash!'}
          iconPath={
