  ...
  return (
    <>
      <Section id={'donate'} className={'gap-3'}>
        ...
        <p>
          Your support enables me to continue creating valuable content and
          projects that benefit the community. By donating, you directly
          contribute to the growth and sustainability of my work, helping me
          pursue my passion and make a difference.
        </p>
        ...
        <List>
          ...
          <ListItem>
            ...
            <Link
              title={'Sponsor Prakash Ravichandran on GitHub'}
              href={'https://github.com/sponsors/PrakasRavichandran/'}
            >
              more
            </Link>
            !
...
export const metadata = createMetadata({
  title: 'Donate – Prakash Ravichandran',
  description:
    // eslint-disable-next-line max-len
    'Support Prakash Ravichandran. Donate or sponsor him as a recognition for his work on different projects.',
  exactUrl: 'https://prakashravichandran.com/donate',
  keywords: [
    'donate',
    'support',
    'sponsor',
