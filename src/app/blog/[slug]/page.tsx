...
const blogPostStructuredData = (post?: PartialBlog): string => {
  ...
  return JSON.stringify({
    ...
    image: `https://prakashravichandran.com/blog/${post.slug}/opengraph-image`,
    url: `https://prakashravichandran.com/blog/${post.slug}`,
    author: {
      '@type': 'Person',
      name: 'Prakash Ravichandran',
      url: 'https://prakashravichandran.com/about',
    },
  });
};
      ...
      >
        <div className={'flex flex-row items-center gap-2.5 tablet-md:gap-3'}>
          ...
          <OutlinedLinkButton
            ...
            href={`https://github.com/PrakasRavichandran/prakashravichandran.com/edit/main/content/${slug}.mdx`}
            className={'pr-3.5'}
          >
            <Icon
              className={'size-5'}
...
export function generateMetadata(
  ...
  const metadata = createMetadata({
    title: `${title} | Blog – Prakash Ravichandran`,
    description: summary || 'Blog post by Prakash Ravichandran',
    exactUrl: `https://prakashravichandran.com/blog/${slug}`,
