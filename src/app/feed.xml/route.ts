...
const formatImageUrl = (url?: string) => {
  if (!url) return '';
  if (url.startsWith('/')) return `https://prakashravichandran.com${url}`;
  return url;
};
...
const buildDescriptionHtml = (post: PartialBlog): string => {
  ...
  if (post.link)
    ...
    description += `<b><a href="https://prakashravichandran.com/blog/${post.slug}">Read more...</a></b><br/><br/>`;
...
const getAllPostRssData = (post: PartialBlog) => {
  ...
  return {
    title: post.title,
    url: post.link || `https://prakashravichandran.com/blog/${post.slug}`,
    date: post.date,
...
const defaultChannel = {
  'atom:link': {
    _attr: {
      href: 'https://prakashravichandran.com/feed.xml',
      rel: 'self',
  ...
  language: 'en-US',
  link: 'https://prakashravichandran.com',
  title: 'Prakash Ravichandran',
  description: 'Passionate and creative embedded systems engineer from India',
  image_url: 'https://prakashravichandran.com/api/og',
  image: {
    title: 'Prakash Ravichandran',
    link: 'https://prakashravichandran.com',
    url: 'https://prakashravichandran.com/api/og',
  },
  copyright: `All rights reserved ${new Date().getFullYear()}, Prakash Ravichandran`,
};
