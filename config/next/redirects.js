...
const redirects = [
  ...
  buildRedirect('/static/images/me/me.jpg', '/media/prakash/prakash.jpg'),
  /* Dashbud links */
  ...
  /* Other redirections */
  buildRedirect('/links', 'https://bio.prakashravichandran.com'),
  ...
  buildRedirect('/resume', 'https://prakashravichandran.com/share/prakash-ravichandran-Resume.pdf'),
  buildRedirect('/shop', 'https://www.shop.dev/nuestros-productos'),
  buildRedirect(
    '/analytics',
    'https://umami.is',
  ),
